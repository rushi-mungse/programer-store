...
const Navigation = () => {
  return (
    <div className="border-y border-black">
      <ul className="container text-[14px] flex items-center justify-between">
        <li className="cursor-pointer mr-6 hover:text-blue-500 transition-all duration-300 ease-in-out">
